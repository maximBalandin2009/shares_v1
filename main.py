...
def fixFirstAndLastDate(name):
    ...
    def printInputTimeFinish():
        ...
        def finalButton():
            timef = tk.Label(
                text='Внимание! Для того, чтобы перезагрузить вкладку Вам нужно будет закрыть окно с графиком!',
                font=("Arial", 20))
            timef.pack()
        ...
        def printPlotStock(df):
            ...
            line_plot_std30, = axs[0].plot(listDatesSTD, listSTD, color='red',
            ...
            line_plot_std200, = axs[0].plot(listDatesSTD1, listSTD1, color='purple',
            ...
            line_plot_30 = axs[1].plot(listDatesRSI, list30, color='r')
            line_plot_70 = axs[1].plot(listDatesRSI, list70, color='r')
